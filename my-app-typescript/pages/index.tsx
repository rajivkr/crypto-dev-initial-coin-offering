...
export default function Home() {
   ...
   */
  // Using any here as we can't use Bignumber since we have to multiply by 0.001.
  // BigNumber doesn't support decimal points yet.
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        ...
        <div>
          <img className={styles.image} src='./0.svg' alt='Crypto Dev Token' />
        </div>
      </div>
